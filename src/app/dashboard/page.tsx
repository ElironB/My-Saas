...
export function Dashboard() {
    ...
    const { user } = useUser();
    const image_url = user?.user_metadata?.avatar_url
        ...
        <nav className="flex flex-col items-center gap-4 px-2 py-4">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="right" className=" text-base">Dashboard</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="right" className=" text-base">Mind Map</TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <TooltipProvider>
            <Tooltip>
        ...
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem className=" text-red-400" onClick={handleLogout}>Logout</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </header>
